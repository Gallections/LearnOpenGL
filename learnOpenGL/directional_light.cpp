...
int main() {
    ...
    // Load Textures (we now use the lamp's position attribute's stride to reflect the updated buffer data
    unsigned int diffuseMap = loadTexture("container2.png");
    unsigned int specularMap = loadTexture("container2_specular.png");

    lightingShader.use();
    lightingShader.setInt("material.diffuse", 0); // this is assigning material.diffuse with the texture at first texture unit.
