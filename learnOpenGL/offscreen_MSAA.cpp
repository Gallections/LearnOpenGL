...
//
//    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Learn Offscree MSAA", NULL, NULL);
//
//    if (window == NULL)
//    {
...
//
//        // draw scene as normal in multisampleed buffers
//        glBindFramebuffer(GL_FRAMEBUFFER, framebuffer);
//        glClearColor(0.1f, 0.1f, 0.1f, 1.0f);
//        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
//        glEnable(GL_DEPTH_TEST);
...
//        glBindTexture(GL_TEXTURE_2D, screenTexture);  // use the now resolved color attachment as he quad's texture
