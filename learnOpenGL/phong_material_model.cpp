...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Material Based Phong Model", NULL, NULL);
	if (window == NULL) {
	...
	// second, configure the light's VAO (VBO stays the same; the vertices are the same for the light)
