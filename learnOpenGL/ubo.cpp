...
int main() {
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Learn OpenGL UBOs", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // set the view and projection matrix in the uniform block - we only have to do this once per loop
